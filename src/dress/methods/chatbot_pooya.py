...
input_dir = "/home/saman/Desktop/thesis_/DRESS_final/data/wikismalll/wikismall_final/small_test_input.txt"
inputs = open(input_dir, encoding='utf-8', errors='ignore').read().split('\n')
inputs = inputs[:-1]

output_dir = "/home/saman/Desktop/thesis_/DRESS_final/data/wikismalll/wikismall_final/small_test_input.txt"
outputs = open(output_dir, encoding='utf-8', errors='ignore').read().split('\n')
outputs = outputs[:-1]

save_dir = "/home/saman/Desktop/thesis_/DRESS_final/data/rnn_saved"
corpus = "/home/saman/Desktop/thesis_/Old_not_clean/MyTorch/cornell movie-dialogs corpus"

corpus_name = "cornell movie-dialogs corpus"
corpus = "/home/saman/Desktop/thesis_/Old_not_clean/MyTorch/"
corpus = os.path.join(corpus, corpus_name)
...
#     for line in lines[:n]:
#         print(line)
# printLines("/home/saman/Desktop/thesis_/Old_not_clean/MyTorch/cornell movie-dialogs corpus/movie_lines.txt")
####
...
def train(L,input_variable, lengths, target_variable, mask, max_target_len, encoder, decoder, embedding,
    ...
    if use_teacher_forcing:
        ...
        for t in range(L, max_target_len):
            decoder_output, decoder_hidden = decoder(
                decoder_input, decoder_hidden, encoder_outputs
            )
            # Teacher forcing: next input is current target
            ...
            mask_loss, nTotal = maskNLLLoss(decoder_output, target_variable[t], mask[t])
            loss_rl += mask_loss
            print_losses.append(mask_loss.item() * nTotal) # decoder_hidden == hT na Ct  hamun context dar attention ast.
            n_totals += nTotal
    else:
        for t in range(0, L):
            b, r = 0, 0
            ...
            # Calculate and accumulate loss
            mask_loss, nTotal = maskNLLLoss(decoder_output, target_variable[t], mask[t])
            rl_rein = torch.log(decoder_output * (r + b))
            loss_rl += rl_rein
            print_losses.append(mask_loss.item() * nTotal)
            n_totals += nTotal
        # if L > 0:
...
def trainIters(model_name, voc, pairs, encoder, decoder, encoder_optimizer, decoder_optimizer, embedding,
    ...
    for iteration in range(start_iteration, n_iteration + 1):
        ...
        loss = train(L, input_variable, lengths, target_variable, mask, max_target_len, encoder,
